...
fn clientbound_packet_id_override(version_number: i32, packet_name: &str) -> Option<u8> {
    match (version_number, packet_name) {
        ...
        (764, "minecraft:set_objective") => Some(0x5a),
        (765, "minecraft:set_objective") => Some(0x5c),
        ...
        (764, "minecraft:set_display_objective") => Some(0x53),
        (765, "minecraft:set_display_objective") => Some(0x55),
        ...
        (764, "minecraft:set_score") => Some(0x5d),
        (765, "minecraft:set_score") => Some(0x5f),
        ...
        (764, "minecraft:set_player_team") => Some(0x5c),
        (765, "minecraft:set_player_team") => Some(0x5e),
...
fn serverbound_packet_id_override(version_number: i32, packet_name: &str) -> Option<u8> {
    match (version_number, packet_name) {
        ...
        (759..=761, "minecraft:player_action") => Some(0x1c),
